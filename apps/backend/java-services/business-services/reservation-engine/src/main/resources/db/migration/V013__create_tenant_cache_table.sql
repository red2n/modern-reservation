-- =====================================================
-- Migration: V013 - Create Tenant Cache Table
...
-- Add comments
COMMENT ON TABLE tenant_cache IS 'Local read-only cache of tenant data synchronized from Tenant Service via Kafka events';
