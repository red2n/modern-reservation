package com.modernreservation.reservationengine.kafka;

import com.modernreservation.reservationengine.service.TenantCacheService;
...
/**
 * TenantEventConsumer - Kafka listener for tenant events
 *
 ...
 * 5. Business logic uses updated cache (fast local access!)
 *
 * Benefits:
